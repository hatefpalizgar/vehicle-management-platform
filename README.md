...
I use npm scripts and [Webpack][] as our build system.
...
Note: There are still a few other things remaining to do for Leaflet that I won't detail here.
...
To build the final jar and optimize the VehicleManagementPlatform application for production, run:
